...
class LoadDicomFileDialog(Dialog):
    ...
    def file_path_label(self):
        if not self._file_path_label:
            self._file_path_label = QLabel(constants.MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_FILE_PATH_LABEL_TEXT)
        return self._file_path_label
    
    def file_path_text_edit(self):
        if not self._file_path_text_edit:
            self._file_path_text_edit = QTextEdit(placeholderText=constants.MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_FILE_PATH_TEXT_EDIT_PLACEHOLDER_TEXT)
        return self._file_path_text_edit
    
    def open_file_select_dialog_button(self):
        if not self._open_file_select_dialog_button:
            self._open_file_select_dialog_button = QPushButton(constants.MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_OPEN_SELECT_FILE_DIALOG_BUTTON_TEXT)
    ...
    def load_button(self):
        if not self._load_button:
            self._load_button = QPushButton(constants.MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_LOAD_BUTTON_TEXT)
    ...
    def handle_open_file_select_dialog_button(self):
        ...
        file_path, _ = QFileDialog.getOpenFileName(self, constants.MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_OPEN_SELECT_FILE_PATH_DIALOG_WINDOW_TITLE, dir=last_directory)
        if file_path:
