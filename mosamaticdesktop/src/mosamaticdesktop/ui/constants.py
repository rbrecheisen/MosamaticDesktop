...
MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_FILE_PATH_LABEL_TEXT = 'File path'
MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_FILE_PATH_TEXT_EDIT_PLACEHOLDER_TEXT = 'Enter file path'
MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_OPEN_SELECT_FILE_DIALOG_BUTTON_TEXT = 'Select DICOM file...'
MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_OPEN_SELECT_FILE_PATH_DIALOG_WINDOW_TITLE = 'Select DICOM file'
MOSAMATICDESKTOP_LOAD_DICOM_FILE_DIALOG_LOAD_BUTTON_TEXT = 'Load'